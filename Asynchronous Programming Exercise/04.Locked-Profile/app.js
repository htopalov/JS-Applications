function lockedProfile() {
    ...
    function createHtmlProfile(userIndex,username,email,age){
        ...
        let hiddedFieldsHr = document.createElement('hr');
        ...
        hiddenFieldsDiv.appendChild(hiddedFieldsHr);
    ...
    function showHiddenInfoHandler(e){
        ...
        let hiddenDivField = e.target.previousElementSibling;
        ...
        hiddenDivField.style.display = hiddenDivField.style.display === 'block' ? 'none' : 'block';
    }
}