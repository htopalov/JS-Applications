...
describe('E2E tests', function () {
    ...
    describe('Navigation bar [ 5 Points ]', () => {
        it.only('guest user should see correct navigation [ 2 Points ]', async () => {
            await page.goto(host);
            await page.waitForTimeout(interval);
        ...
        it.only('logged user should see correct navigation [ 2 Points ]', async () => {
            // Login user
            const data = mockData.users[0];
            await page.goto(host);
            await page.waitForTimeout(interval);
        ...
        it.only('user should see correct navigation after click on Logout button [ 1 Points ]', async () => {
            // Login user
            const data = mockData.users[0];
            await page.goto(host);
            await page.waitForTimeout(interval);
    ...
    describe('Catalog [ 20 Points ]', () => {
        it.only('show empty catalog [ 2.5 Points ]', async () => {
        ...
        it.only('show catalog [ 7.5 Points ]', async () => {
            await page.goto(host);
            await page.waitForTimeout(interval);
        ...
        it.only('show details [ 5 Points ]', async () => {
        ...
        it.only('guest does NOT see edit/delete buttons [ 5 Points ]', async () => {
    ...
    describe('CRUD [ 45 Points ]', () => {
        ...
        it.only('create does NOT work with empty fields [ 5 Points ]', async () => {
        ...
        it.only('non-author does NOT see delete and edit buttons [ 5 Points ]', async () => {
            const data = mockData.catalog[2];
            await page.click('nav >> text=Dashboard');
            await page.waitForTimeout(interval);
        ...
        it.only('author sees delete and edit buttons [ 5 Points ]', async () => {
        ...
        it.only('delete makes correct API call for logged in user [ 5 Points ]', async () => {
            const data = mockData.catalog[0];
    ...
    describe('My Books Page [ 10 Points ]', async () => {
        ...
        it.only('the logged-in user should be able to see his/her own books (test with 2 books) [ 2 Points ]', async () => {
            await page.goto(host);
            await page.waitForTimeout(interval);
        ...
        it.only('the logged-in user should be able to see "No books in database!" (test with 0 books) [ 2 Points ]', async () => {
        ...
        it.only('the logged-in user should be able to view his/her own books - detailed information [ 4 Points ]', async () => {
        ...
        it.only('the logged-in user should be redirected to the Details page after click on the button "Details" [ 2 Points ]', async () => {
            const data = mockData.catalog[0];
            await page.goto(host);
            await page.waitForTimeout(interval);
            await page.click('text=My Books');
    ...
    describe('BONUS : Like functionality  [ 10 Points ]', async () => {
        ...
        it.only('Like button is not visible for guest users [ 1 Points ]', async () => {
            const data = mockData.catalog[0];
            await page.goto(host);
            await page.waitForTimeout(interval);
        ...
        it.only('Like button is visible for the non-creator user [ 2 Points ]', async () => {
            // Login user
        ...
        it.only('Like button is not visible for the creator [ 2 Points ]', async () => {
            // Login user
            const user = mockData.users[0];
            const data = mockData.catalog[0];
